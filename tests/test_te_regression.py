...
class TestTEModification(unittest.TestCase):
    ...
    def train_bluntTE(self, train=True):
        self.test_bluntTE(train=train)
    ...
    def train_bluntTE_rotated(self, train=True):
        self.test_bluntTE_rotated(train=train)
    ...
    def train_roundTE(self, train=True):
        self.test_roundTE(train=train)
    ...
    def train_roundTE_rotated(self, train=True):
        self.test_roundTE_rotated(train=train)
    ...
    def train_sharpenTE(self, train=True):
        self.test_sharpenTE(train=train)
    ...
    def train_sharpenTE_rotated(self, train=True):
        self.test_sharpenTE_rotated(train=train)
